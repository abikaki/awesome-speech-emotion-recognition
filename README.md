...
| [ESD](https://github.com/HLTSingapore/Emotional-Speech-Data?tab=readme-ov-file) <br/> [![GitHub](https://img.shields.io/github/stars/HLTSingapore/Emotional-Speech-Data)](https://github.com/HLTSingapore/Emotional-Speech-Data) | English (North American), Chinese (Mandarin) | 10 English (5 males and 5 females) and 10 Chinese (5 males and 5 females) speakers, 350 utterances each | Acted | Anger, happiness, neutral, sadness, surprise | Audio <br> Text | Audio: 16kHz <br/> Formats: wav    
